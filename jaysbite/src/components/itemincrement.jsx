    ...
    <div className="flex flex-col gap-5 bg-white max-w-75 py-5 px-2 rounded-lg shadow-sm">
      ...
      <div className="flex flex-col gap-3 px-3">
        ...
        <a
          ...
          className="border border-purple-800 bg-purple-800 rounded-2xl py-1.5 px-5 text-base text-center text-white hover:cursor-pointer hover:text-purple-800 hover:bg-white transition-all ease-out"
        >
          Order Now
        </a>
      </div>
